// Fetch and display registered death cattle
$.ajax({
    url: '/api/death-list/',  // Correct API endpoint for registered death cattle
    method: 'GET',
    dataType: 'json',
    success: function (data) {
        ...
        $('#death-table').on('click', '.edit-btn', function () {
            var id = $(this).data('id');
            // Handle the edit action here
            alert('Edit action for ID: ' + id);
        });

        $('#death-table').on('click', '.delete-btn', function () {
            var id = $(this).data('id');
